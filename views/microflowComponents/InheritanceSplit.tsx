...
export class InheritanceSplit extends React.Component<{ data: microflow.IInheritanceSplit, style?: any }, {}>{
    render() {
        var style = {
        ...
        return (
            <div className="microflow-wrapper" style={style}>
                <svg width={this.props.data.geometry.width + 2} height={this.props.data.geometry.height + 2}>
                    <linearGradient id="gradient-mx-mf-inheritancesplit" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0" style={{ "stopColor": "#ffffff" }}></stop>
                        <stop offset="1" style={{ "stopColor": "#88a529" }}></stop>
                    </linearGradient>
                    <g transform="translate(1, 1)">
                        <polygon points={polygon1} stroke="black" fill="url(#gradient-mx-mf-inheritancesplit)" />
                    </g>
                </svg>
