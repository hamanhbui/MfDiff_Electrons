...
export function convertSplitCondition(flow: microflows.SequenceFlow, originPos: _cpnInterface.microflow.IGeometry, destinationPos: _cpnInterface.microflow.IGeometry, ): _cpnInterface.microflow.IEntity {
