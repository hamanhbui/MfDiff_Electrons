...
export function convertAnnotationFlow(flow: microflows.AnnotationFlow, originPos: _cpnInterface.microflow.IGeometry, destinationPos: _cpnInterface.microflow.IGeometry): _cpnInterface.microflow.IAnnotationFlow {
    ...
    else if (flow.originConnectionIndex === 3) {
    ...
    let cpnIFlow: _cpnInterface.microflow.IAnnotationFlow = {
        id: flow.id,
        origin: origin1,
        ...
        type: _cpnTypeEnum.TypeEnum.AnnotationFLow
    }
    return cpnIFlow;
}//todo